//==============================================================
// 16-bit Carry Select Adder (Dataflow Style)
//--------------------------------------------------------------
// Timing Analysis:
//   DELAY_PS = adder4_delay + mux_delay
//   Critical path:
//     4-bit adder -> carry-select mux chain
//
// Area Analysis:
//   AREA_UM2 = 8 * adder4_area + 3 * mux4_area
//   (2 candidate adders per block × 4 blocks)
//   (3 carry-select mux stages)
//
// Power Analysis:
//   POWER_UW = AREA_UM2 × activity × VDD² × frequency
//==============================================================
